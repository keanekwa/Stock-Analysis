        ...
        <Grid item xs={12}>
          ...
          {data !== null && (
            <div>
              ...
              <Typography variant="body1">Mean Revenue Increase Per Year: {data.mean_revenue_increase_per_year} years)</Typography>
              <Typography variant="body1">Mean Net Income Increase Per Year: {data.mean_net_income_increase_per_year} years)</Typography>
              <Typography variant="body1">Mean Cashflow Increase Per Year: {data.mean_cashflow_increase_per_year} years)</Typography>
              ...
              <Typography variant="body1">Mean Revenue Increase Per Quarter: {data.mean_revenue_increase_per_quarter} quarters)</Typography>
              <Typography variant="body1">Mean Net Income Increase Per Quarter: {data.mean_net_income_increase_per_quarter} quarters)</Typography>
              <Typography variant="body1">Mean Cashflow Increase Per Quarter: {data.mean_cashflow_increase_per_quarter} quarters)</Typography>
